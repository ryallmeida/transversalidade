# TRATAMENTO DO CORPUS: ANÁLISE DOS PLANOS PLURIANUAIS [PPA] DE PERNAMBUCO 
# PERÍODO (2008-2025)
# ----------------------------------------
# TITULO DO TRABALHO 
...
readr::write_csv(
  resultado_limpo,
  "C:/Users/ryall/Downloads/ppa_preprocessado(1).csv",
  na = "",
  quote = "needed"
)
...
tokens_ppa <- dados_sentimento$texto_limpo |>
  tokens(
    remove_punct = TRUE,
    remove_symbols = TRUE,
    remove_numbers = TRUE
...
readr::write_csv(
  dados_sentimento,
  "C:/Users/ryall/Downloads/ppa_nivel_palavra.csv",
  na = "",
  quote = "needed"
)
...
ppa_sumarizado <- dados_sentimento %>%
...
ppa_nivel_paragrafo <- resultado_limpo %>%
  left_join(
    ppa_sumarizado,
    by = "paragrafo_id"
  )
...
readr::write_csv(
  ppa_nivel_paragrafo,
  "C:/Users/ryall/Downloads/ppa_nivel_paragrafo.csv",
  na = "",
  quote = "needed"
)

ppa_nivel_paragrafo <- readr::read_csv(
  "C:/Users/ryall/Downloads/ppa_nivel_paragrafo.csv",
  show_col_types = FALSE
)
...
ppa_nivel_paragrafo  <- ppa_nivel_paragrafo  %>%
  mutate(
...
prop.table(table(ppa_nivel_paragrafo$tipo1))

#   NEGATIVO     NEUTRO   POSITIVO 
#   NEGATIVO     NEUTRO   POSITIVO 
# 0.03446613 0.75687852 0.20865535 
...
# HYPERPOSITIVO    NEGATIVO_1    NEGATIVO_4        NEUTRO    POSITIVO_1 
#   0.055805914   0.083518386   0.006100085   0.409795388   0.069849421 
#    POSITIVO_2    POSITIVO_3    POSITIVO_4 
#   0.030507771   0.043182546   0.301240488 

bp <- boxplot.stats(ppa_nivel_paragrafo$soma_media_intensidades)
...
prop.table(table(ppa_nivel_paragrafo$tipo2))

# HYPERPOSITIVO    NEGATIVO_1    NEGATIVO_2    NEGATIVO_3    NEGATIVO_4 
#   0.066298343   0.074277328   0.006893745   0.023394337   0.012159629 
#        NEUTRO    POSITIVO_1    POSITIVO_2    POSITIVO_3    POSITIVO_4 
#   0.401995363   0.026958366   0.021211523   0.039154992   0.327656373 
...
#    0.01052280    0.17256067    0.06418463    0.46126516    0.12747810 
#    POSITIVO_2    POSITIVO_3    POSITIVO_4 
#    0.05236312    0.03418574    0.07743979 
...
bp2 <- boxplot.stats(ppa_nivel_paragrafo$tfidf_intensidade)
...
prop.table(table(ppa_nivel_paragrafo$tipo3))

# HYPERNEGATIVO HYPERPOSITIVO    NEGATIVO_1    NEGATIVO_2    NEGATIVO_3 
#   0.002494705   0.084478701   0.068380795   0.004259826   0.018769122 
#    NEGATIVO_4        NEUTRO    POSITIVO_1    POSITIVO_2    POSITIVO_3 
#   0.022322900   0.383772652   0.087361732   0.088750294   0.073782066 
#    POSITIVO_4 
#   0.165627206 
...
resultado_final <- bind_rows(
  ...
  resumo_prop(ppa_nivel_paragrafo, "tipo1", "paragrafo"),
  resumo_prop(ppa_nivel_paragrafo, "tipo2", "paragrafo"),
  resumo_prop(ppa_nivel_paragrafo, "tipo3", "paragrafo")
)

resultado_final$documento <- "PPA"

readr::write_csv(
  resultado_final,
  "C:/Users/ryall/Downloads/proporcao_ppa.csv",
  na = "",
  quote = "needed"
)

# ==============================================================================
# QUANTIFICANDO VARIÁVEIS EM ESPECTRO
# ==============================================================================
...
table(ppa_nivel_paragrafo$tipo2, ppa_nivel_paragrafo$espectro_tipo2)
table(ppa_nivel_paragrafo$tipo3, ppa_nivel_paragrafo$espectro_tipo3)
...
readr::write_csv(
  dados_sentimento,
  "C:/Users/ryall/Downloads/ppa_processado_npalavra.csv",
  na = "",
  quote = "needed"
)
...
readr::write_csv(
  ppa_nivel_paragrafo,
  "C:/Users/ryall/Downloads/ppa_corpus_paragrafo.csv",
  na = "",
  quote = "needed"
)
...
readr::write_csv(
  dados_sentimento,
  "C:/Users/ryall/Downloads/ppa_corpus_palavra.csv",
  na = "",
  quote = "needed"
)
